<template>
  <section class="flex flex-wrap w-full">
    <div class="m-auto">
      <h1 class="text-2xl my-5 bg-gradient-to-r from-blue-700 to-pink-500 text-white  px-4 py-2 rounded">Re-useable Modal</h1>
      ...
      <button
        class="border rounded px-2 mx-4 bg-gradient-to-r from-blue-700 to-pink-500 text-white"
